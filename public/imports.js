...
export const size_array = ["XS", "S", "M", "L", "XL", "XXL", "XXXL"];
...
export const newInArray = ["Hoodies", "Sweatpants", "T-Shirts"];
...
export const men_kicks = ["Sneakers", "Boots", "Shoes", "Slides", "Formal"];

export const men_accessories = ["Bags", "Caps"];
...
export const women_kicks = ["Heels", "Flats", "Sneakers", "Boots", "Sandals"];

export const women_accessories = ["Caps", "Bags", "Leggings"];
...
export const kids_clothing = ["Hoodies", "Sweaters", "Sweatpants", "T-Shirts"];

export const kids_accessories = ["Caps", "Bags"];
